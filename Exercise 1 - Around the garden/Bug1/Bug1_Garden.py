...
def acc():
    ...
    if ((motor_left_target == 0 and motor_left_speed*motor_left_speed > 121) or (motor_right_target == 0 and motor_right_speed*motor_right_speed > 100)) and can_print_mot:
