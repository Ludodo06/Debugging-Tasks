...
def timer0():
    ...
    if current_step == 2: right(90)
    if current_step == 3: forward(1)
    if current_step == 4: right(90)
    if current_step == 5: forward(1)
    if current_step == 6: left(90)
    if current_step == 7: forward(1)
    if current_step == 8: right(90)
