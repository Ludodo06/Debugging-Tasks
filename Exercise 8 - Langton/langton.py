...
@onevent
def timer0():
    global leds_top,motor_left_target, motor_right_target, tourne
...
@onevent
def prox():
    global timer_period, motor_left_target, motor_right_target, tourne

    if prox_horizontal[2] > 2500 and not tourne:
        nf_leds_top(32,16,0) # Orange
        if prox_ground_delta[0] > 500:
            motor_right_target = -200
            motor_left_target = 200
        else:
            motor_right_target = 200
